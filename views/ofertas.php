    ...
    <main>
        ...
        <section>
            <div class="product-container">
                <?php
                $sql = "SELECT id, nombre, precio, imagen, descripcion FROM productos WHERE oferta = 1 ORDER BY id DESC";
                ...
                <?php
                    ...
                    echo "<p class='text-center'>No hay productos en oferta.</p>";
                }
                $conexion->close();
                ?>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.product-card').forEach(card => {
                ...
                botonDetalles.addEventListener('click', (e) => {
                    ...
                    document.getElementById('addToFavoritesModalBtn').dataset.originalButtonId = botonDetalles.dataset.nombre; // Use name as identifier
